...
|---|---|---|
| [bubble_sort_loesung](doc/loesungen/bubble_sort_loesung.md) | Musterlösungen zu den Bubble‑Sort‑Aufgaben. | Python‑Grundkenntnisse |
| [linked_list_loesung](doc/loesungen/linked_list_loesung.md) | Musterlösungen zu den Linked‑List‑Aufgaben. | Listenverständnis |

## HANDBUCH
| Dokumentname | Erläuterung | Vorkenntnisse |
|---|---|---|
| [projekt_handbuch](doc/handbuch/projekt_handbuch.md) | Hinweise zur Repository‑Struktur, Beitragsregeln und Entwicklungsrichtlinien. | Git‑Grundlagen |

Hinweis: Falls die tatsächlichen Dateinamen oder Verzeichnisse abweichen, passe die Links entsprechend an.